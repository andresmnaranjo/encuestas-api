...
module.exports = {
    ...
    async getAll(req, res, next) {
        const records = await tipousuarioservice.getAll();
    ...
    async getById(req, res, next) {
        ...
        const record = await tipousuarioservice.getById(id);
    ...
    async save(req, res) {
        const reqRecibido = new Tipousuario();
        ...
        try {
            ...
            const reqAlmacenado = await tipousuarioservice.save(reqRecibido);
